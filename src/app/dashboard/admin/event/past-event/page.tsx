...
// Define the type for events coming from the API
interface Event {
              ...
              <tbody>
                {filteredEvents.map((event, index) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-gray-700">{event.alumni.user.name}</td>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedEvent.alumni.user.name}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
