...
export default function LoginPage() {
      ...
      <header className="flex items-center justify-between border-b border-solid border-b-gray-200 px-6 py-4">
        <div className="flex items-center gap-4">
          <div className="text-blue-600">
            <img src="/logo.jpg" alt="logo" className="h-10 w-10 rounded"></img>
          </div>
        ...
        <nav className="flex gap-6">
          ...
          <a href="#" className="text-sm font-medium text-gray-900">Events</a>
          <a href="#" className="text-sm font-medium text-gray-900">Groups</a>
          <a href="#" className="text-sm font-medium text-gray-900">Mentorship</a>
          <a href="#" className="text-sm font-medium text-gray-900">Benefits</a>
        </nav>
        <div className="flex gap-3">
          <button className="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-bold">Give</button>
          <button className="bg-gray-200 text-gray-900 px-4 py-2 rounded-md text-sm font-bold">Sign In</button>
        </div>
      </header>
  ...
  <div className="container mx-auto flex flex-col items-center">
    ...
    <div className="flex space-x-4 mb-4">
      <a href="https://www.linkedin.com/in/krmuniv/" className="bg-white rounded-full py-1 px-2"><span className="text-black font-bold">in</span>
      </a>
      <a href="https://www.youtube.com/@KRMangalamUniversity" className="bg-white rounded-full py-1 px-2"><span><img src="/youtube.png" className="h-6 w-6"></img> </span>
      </a>
      <a href="#">
      </a>
    </div>
