...
const testimonials = [
    {
        id: 1,
        text: "KR Mangalam University has built a strong and vibrant alumni network that continues to make an impact across various industries. The alumni community is a testament to the university's commitment to excellence, providing a lifelong connection to peers, mentors, and faculty members. Graduates of KR Mangalam University have gone on to achieve remarkable success in their respective fields, excelling in corporate leadership, entrepreneurship, research, and innovation.",
        author: "Rishabh Rajput",
        role: "Student, KRMU",
        year: "2023-25",
        image: "/testimonial/rishabh.jpeg",
    },
    {
        id: 2,
        text: "KR Mangalam University has built a strong and vibrant alumni network that continues to make an impact across various industries. The alumni community is a testament to the university's commitment to excellence, providing a lifelong connection to peers, mentors, and faculty members. Graduates of KR Mangalam University have gone on to achieve remarkable success in their respective fields, excelling in corporate leadership, entrepreneurship, research, and innovation.",
